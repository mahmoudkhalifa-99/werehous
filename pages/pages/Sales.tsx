...
const REPORT_LABELS: Record<string, string> = {
    ...
    'petrology_detailed': 'بيان مبيعات بيوتولوجى اليومي',
...
export const Sales: React.FC = () => {
    ...
    const isInsideReport = useMemo(() => {
        return viewMode !== 'menu' && viewMode !== 'reports' && !!REPORT_LABELS[viewMode];
    }, [viewMode]);
                ...
                <div className="flex flex-col gap-2 relative z-10 shrink-0">
                    ...
                    {isInsideReport && (
                        <button 
                            ...
                            className="flex items-center gap-2 bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-xl font-black shadow-lg transition-all active:scale-95 text-[10px] animate-fade-in"
                        >
                            <LayoutGrid size={14} />
